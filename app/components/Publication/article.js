...
export default class Article extends Component {
  ...
  render () {
    ...
    return (<tr className={status}>
      ...
      <td className='title'><Link className='pull-left add-record' to={`/publications/${encodeURIComponent(publicationDoi)}/addarticle/${encodeURIComponent(doi)}`}>{title}</Link></td>
