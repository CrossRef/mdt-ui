...
import {appendElm,appendAttribute,isISSN} from '../utilities/helpers'
...
export default class AddPublicationModal extends Component {
  ...
  validation = async () => {
    ...
    criticalErrors.onlineISSNInvalidError = this.state.electISSN.length ? !isISSN(this.state.electISSN): false
    criticalErrors.onlineDuplicateISSN = false
    criticalErrors.printISSNInvalidError = this.state.printISSN.length ? !isISSN(this.state.printISSN): false
  ...
  render () {
    ...
    const doiPrefix = this.state.DOI.substring(0,this.state.DOI.indexOf('/'))
    // Owner will only appear when doing a search. Might want to bring owner along for use here.
    const crossmark = this.props.owner || this.props.crossmarkPrefixes ? this.props.crossmarkPrefixes.indexOf(doiPrefix) !== -1 : false
        ...
        <form className='addPublications'>
          <div className='fieldRowHolder'>
            <div className={(errors.showTitleEmptyError ? 'fieldinput invalid' : 'fieldinput')}>
              <div className='left-indent-36'>Journal title *</div>
            ...
            <div className={(errors.showURLError || errors.showURLEmptyError ? 'fieldinput invalid' : 'fieldinput')}>
              <div className='left-indent-36'>Journal URL *</div>
              <div className='inputholder'>
                <div className='inputinnerholder'>
                  <div className='required'><span>*</span></div>
                  <input
          ...
          <div className='fieldRowHolder'>
            ...
            <div className={(errors.showDOIError || errors.showDOIInvalidError || errors.showDOIEmptyError ? 'fieldinput invalid' : 'fieldinput')}>
              <div className='left-indent-36'>{`Journal DOI${ isEdit ? '' : ' *'}`}</div>
              <div className='inputholder'>
                <div className='inputinnerholder'>
